...
<body>
    ...
    <div class="container">
        ...
        <div style="text-align: center; color: var(--text-muted); font-size: 0.875rem;">
            ...
            <a href="tel:+255767152456" style="display: inline-flex; align-items: center; justify-content: center; gap: 0.5rem; margin-top: 0.5rem; color: var(--primary); font-weight: bold; text-decoration: none; background: #e2e8f0; padding: 0.5rem 1rem; border-radius: 9999px; transition: background-color 0.2s;" onmouseover="this.style.backgroundColor='#cbd5e1'" onmouseout="this.style.backgroundColor='#e2e8f0'">
