        ...
        <div id="mobile-menu" class="hidden md:flex flex-col flex-1 overflow-y-auto">
            <div class="py-4 space-y-1">
                <nav class="space-y-1">
                    ...
                    <a href="{{ route('admin.queues') }}" class="sidebar-link flex items-center px-4 py-2 text-sm font-medium {{ request()->routeIs('admin.queues') ? 'bg-gray-800 text-white' : '' }}">
                    ...
                    <a href="{{ route('admin.logs') }}" class="sidebar-link flex items-center px-4 py-2 text-sm font-medium {{ request()->routeIs('admin.logs') ? 'bg-gray-800 text-white' : '' }}">
